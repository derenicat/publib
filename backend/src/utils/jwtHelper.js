...
// UYARI: JWT gizli anahtarı ve geçerlilik süresi ortam değişkenlerinde tanımlanmalıdır.
// Uygulamanın güvenli ve doğru çalışması için bu değişkenler (`JWT_SECRET`, `JWT_EXPIRES_IN`) zorunludur.
